 ...
 * @throws ApiError
 */
export const objectsRelationsOverviewObjectGraphPost = (data: ObjectsRelationsOverviewObjectGraphPostData): CancelablePromise<ObjectsRelationsOverviewObjectGraphPostResponse> => {
    return __request(OpenAPI, {
        method: 'POST',
