...
export type UpsertAttributesEndpointEditorOcelUpsertAttributesPostResponse = (unknown);
...
export type ObjectsRelationsOverviewObjectGraphPostResponse = (ObjectRealtionsResponse);
...
export type ValidateEmissionRuleValidateEmissionRulePostResponse = (ValidateEmissionRuleResponse);
...
export type GetAvailableAttributesForEmissionRuleGetAvailableAttributesPostResponse = (GetAvailableAttributesResponse);
...
export type ComputeEmissionsComputeEmissionsPostResponse = ((TaskStatusResponse | ComputeEmissionsResponse));
...
export type ObjectAllocationObjectAllocationPostResponse = (ObjectAllocationResponse);
...
export type GetClimatiqUnitsClimatiqUnitsListGetResponse = (Array<ClimatiqUnitType>);
